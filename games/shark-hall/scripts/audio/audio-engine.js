...
//
// This is Mini Hoops' engine, carried over unchanged. It reads its mix entirely
// from `sound-catalog.js`, so the only thing that makes it this cabinet's engine
// is the catalog beside it — which is exactly why it was worth reusing.
//
...
// started that much further INTO the file rather than late. Nothing in this
// cabinet asks for it — no sound here is welded to a clock — but it costs
// nothing and the option is kept rather than deleted and missed later.
//
