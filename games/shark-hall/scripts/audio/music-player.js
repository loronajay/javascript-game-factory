...
//
// Carried over from Mini Hoops unchanged, for the same reason the engine was:
// what makes a soundtrack this cabinet's soundtrack is `music-catalog.js`, and
// the streaming, the autoplay retry and the end-of-track handoff are the same
// problem in every cabinet that has one.
//
