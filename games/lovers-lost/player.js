...
function distPerFrame(speed) {
  return Math.pow(speed / SPEED_FLOOR, 0.2);
}
...
if (typeof module !== 'undefined') module.exports = playerModule;
else Object.assign(window, playerModule);
