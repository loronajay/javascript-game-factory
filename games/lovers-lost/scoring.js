...
const { isFinished } = typeof module !== 'undefined'
  ? require('./player')
  : window;
...
// ─── Exports ──────────────────────────────────────────────────────────────────
const scoringModule = { evaluateRun, OUTCOMES };

if (typeof module !== 'undefined') module.exports = scoringModule;
else Object.assign(window, scoringModule);
