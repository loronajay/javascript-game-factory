export function createFurnishings({ THREE, materials: MAT, world, keyLabelForFloor }) {
  ...
  function addDresser(parent, x, z, rotationY = 0, { keyId = null, keyLabel = null, label = 'drawer' } = {}) {
    ...
    const body = new THREE.Mesh(new THREE.BoxGeometry(1.35, 0.9, 0.58), MAT.wood); body.position.y = 0.45; body.castShadow = true; body.receiveShadow = true; root.add(body); world.registerCollider(body, () => world.aabbFromObject(body));
