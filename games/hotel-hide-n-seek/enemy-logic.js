(function attachHotelEnemyLogic(root, factory) {
  ...
  return { ENEMY_STATES, canDetectPlayer, chooseRoamTarget, chooseSpawn, createAwareness, createStairPursuitRoute, createStairRoute, planarDistance, prepareHuntDoor, prepareRoamDoor, selectDetectedTarget, updateAwareness };
});
