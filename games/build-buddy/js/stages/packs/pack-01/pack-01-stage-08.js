import { createTeamworkStage, deck, climb, spikes, lock, tool } from './pack-01-stage-helpers.js';
...
// one spring, so two are stacked: the blue on the roof and another floating
// where the Runner comes back down from the first bounce.
export const pack01Stage08 = createTeamworkStage({
  ...
  route: [
    ...
    deck('exit', 3000, 224, 560, 64, [tool('springBlue', 2800, 880), tool('springYellow', 2800, 440)]),
  ],
  extras: [
