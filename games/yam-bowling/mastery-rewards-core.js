(function exposeMasteryRewards(root, factory) {
  ...
  const RAW_CADENCE = [
    ...
    [8, [["strike-spark", "strike-burst", "Crimson Strike Spark"]]],
    ...
    [22, [["crowd-burst", "strike-burst", "Crowd Roar Strike Burst"]]],
    [23, [["diamond-trail", "ball-trail", "Diamond White Ball Trail", ["global", "ballTrail", "diamond-white"]]]],
    ...
    [27, [["perfect-line-trail", "ball-trail", "Perfect Line Ball Trail"]]],
    [28, [["legend-badge", "badge", "Lane Legend Badge", ["global", "badge", "lane-legend"]]]],
    [29, [["mastery-nameplate", "title", "{first} Mastery Nameplate"]]],
    [30, [
      ["mastery-skin", "skin", "{first} Mastery Skin"],
      ["exclusive-title", "title", "{first} Master"],
    ]],
  ];
