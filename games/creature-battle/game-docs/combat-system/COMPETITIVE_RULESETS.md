...
This document defines ranked-capable ruleset families for Creature Battler.
...
Creature Battler should support multiple ranked-capable ruleset families over time.
