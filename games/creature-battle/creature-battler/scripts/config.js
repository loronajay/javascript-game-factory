...
const RENTAL_ROSTER = [
  ...
  },
  {
    ...
    growth:    { hp: 7.5, mp: 2.2, strength: 0.7, defense: 0.9, intelligence: 1.65, spirit: 1.3, speed: 2.2 },
    resistances: {},
  ...
  },
  {
    ...
    growth:    { hp: 9.5, mp: 3.0, strength: 0.6, defense: 1.1, intelligence: 1.3, spirit: 2.0, speed: 1.0 },
    resistances: {},
  ...
  },
  {
    ...
    growth:    { hp: 8.5, mp: 1.8, strength: 1.75, defense: 0.75, intelligence: 0.7, spirit: 0.8, speed: 1.7 },
    resistances: {},
  ...
  },
  {
    ...
    growth:    { hp: 10.0, mp: 2.0, strength: 0.8, defense: 2.0, intelligence: 1.2, spirit: 1.6, speed: 0.8 },
    resistances: {},
  ...
  },
  {
    ...
    growth:    { hp: 11.0, mp: 1.6, strength: 1.2, defense: 2.1, intelligence: 0.6, spirit: 1.6, speed: 0.4 },
    resistances: {},
...
const MOVES_DATA = [
  ...
  { id: 'petal_mend',       name: 'Petal Mend',      targeting: 'all_allies',  desc: 'Rain healing petals on the whole team, restoring HP to all allies.',             owner: 'flor',       learnedAt: 1,  category: 'heal',    damageClass: 'heal',     element: 'gaia',    basePower: 14, offensiveScaling: 0.22, mpCost: 8,  accuracy: 100, canCrit: false, movePowerModifier: 0 },
  ...
  { id: 'petal_mend_2',     name: 'Petal Mend 2',    targeting: 'all_allies',  desc: 'A richer bloom of healing petals that restores more HP to all allies.',         owner: 'flor',       learnedAt: 42, category: 'heal',    damageClass: 'heal',     element: 'gaia',    basePower: 26, offensiveScaling: 0.22, mpCost: 14, accuracy: 100, canCrit: false, movePowerModifier: 0 },
  ...
  { id: 'petal_mend_3',     name: 'Petal Mend 3',    targeting: 'all_allies',  desc: 'A torrent of restorative petals with deep healing power for all allies.',       owner: 'flor',       learnedAt: 58, category: 'heal',    damageClass: 'heal',     element: 'gaia',    basePower: 40, offensiveScaling: 0.22, mpCost: 22, accuracy: 100, canCrit: false, movePowerModifier: 0 },
  { id: 'world_tree',       name: 'World Tree',      targeting: 'all_enemies', desc: 'Channel the World Tree to strike all foes with gaia energy while healing the whole party.', owner: 'flor', learnedAt: 65, category: 'art', damageClass: 'magic', element: 'gaia', basePower: 38, offensiveScaling: 0.8, mpCost: 30, accuracy: 88, canCrit: true, movePowerModifier: 0, healAllAllies: true, allyHealBasePower: 22, allyHealScaling: 0.22 },
  ...
  { id: 'healing_wave',     name: 'Healing Wave',    targeting: 'self',        desc: 'Wash over self in a soothing wave, restoring HP.',                              owner: 'aquaphant',  learnedAt: 8,  category: 'heal',    damageClass: 'heal',     element: 'water',   basePower: 16, offensiveScaling: 0.22, mpCost: 8,  accuracy: 100, canCrit: false, movePowerModifier: 0 },
  ...
  { id: 'frozen_pulse',     name: 'Frozen Pulse',    targeting: 'single',      desc: 'A freezing burst that deals ice damage and lowers the target Speed.',           owner: 'pengun',     learnedAt: 35, category: 'art',     damageClass: 'magic',    element: 'ice',     basePower: 22, offensiveScaling: 0.85, mpCost: 8,  accuracy: 92,  canCrit: true,  movePowerModifier: 0 },
  { id: 'blizzard',         name: 'Blizzard',        targeting: 'all_enemies', desc: 'Sweep a freezing storm across all enemies.',                                     owner: 'pengun',     learnedAt: 42, category: 'art',     damageClass: 'magic',    element: 'ice',     basePower: 22, offensiveScaling: 0.8,  mpCost: 14, accuracy: 90,  canCrit: true,  movePowerModifier: 0 },
  ...
  { id: 'mend_light',       name: 'Mend Light',       targeting: 'single_ally', desc: 'Channel healing light into one ally to restore their HP.',                        owner: 'lumora',     learnedAt: 1,  category: 'heal',    damageClass: 'heal',     element: 'light',   basePower: 18, offensiveScaling: 0.32, mpCost: 8,  accuracy: 100, canCrit: false, movePowerModifier: 0 },
  ...
  { id: 'rejuvenate',       name: 'Rejuvenate',       targeting: 'all_allies',  desc: 'Rain a soft healing light down on all allies to restore their HP.',               owner: 'lumora',     learnedAt: 18, category: 'heal',    damageClass: 'heal',     element: 'light',   basePower: 12, offensiveScaling: 0.25, mpCost: 14, accuracy: 100, canCrit: false, movePowerModifier: 0 },
  ...
  { id: 'healing_surge',    name: 'Healing Surge',    targeting: 'single_ally', desc: 'Pour a surge of healing light into one ally for a large HP restore.',            owner: 'lumora',     learnedAt: 30, category: 'heal',    damageClass: 'heal',     element: 'light',   basePower: 34, offensiveScaling: 0.35, mpCost: 16, accuracy: 100, canCrit: false, movePowerModifier: 0 },
  ...
  { id: 'mend_light_2',     name: 'Mend Light 2',     targeting: 'single_ally', desc: 'A powerful surge of healing light that restores a large amount of HP.',          owner: 'lumora',     learnedAt: 45, category: 'heal',    damageClass: 'heal',     element: 'light',   basePower: 46, offensiveScaling: 0.35, mpCost: 20, accuracy: 100, canCrit: false, movePowerModifier: 0 },
  ...
  { id: 'full_restore',     name: 'Full Restore',     targeting: 'all_allies',  desc: 'Release a wave of restorative light that heals the whole team.',                  owner: 'lumora',     learnedAt: 55, category: 'heal',    damageClass: 'heal',     element: 'light',   basePower: 22, offensiveScaling: 0.28, mpCost: 28, accuracy: 100, canCrit: false, movePowerModifier: 0 },
  ...
  { id: 'tidal_crash',      name: 'Tidal Crash',      targeting: 'single',      desc: 'Crash a full tidal force into a single target.',                                  owner: 'tidecalf',   learnedAt: 35, category: 'art',     damageClass: 'magic',    element: 'water',   basePower: 52, offensiveScaling: 0.9,  mpCost: 12, accuracy: 86,  canCrit: true,  movePowerModifier: 0 },
  ...
  { id: 'tide_slap_3',      name: 'Tide Slap 3',      targeting: 'single',      desc: 'A fully empowered tidal strike at peak water force.',                            owner: 'tidecalf',   learnedAt: 50, category: 'art',     damageClass: 'magic',    element: 'water',   basePower: 60, offensiveScaling: 0.9,  mpCost: 14, accuracy: 92,  canCrit: true,  movePowerModifier: 0 },
