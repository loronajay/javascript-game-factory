registerMoveAnimations({
  ...
  moss_strike: {
    timeline: [
      ...
      { at:0,   type:'creature_tint',  target:'actor',  color:'#556633', blend:'screen',   duration:380 },
      { at:0,   type:'preset',         id:'earth_cast_aura' },
      { at:0,   type:'particle_stream',origin:'actor',  color:'#556633', count:5, spread:28, direction:'up', duration:300 },
      ...
      { at:360, type:'creature_tint',  target:'target', color:'#334422', blend:'multiply', duration:460 },
  ...
  moss_strike_2: {
    timeline: [
      ...
      { at:0,   type:'creature_tint',  target:'actor',  color:'#556633', blend:'screen',   duration:400 },
      { at:0,   type:'preset',         id:'earth_cast_aura', count:9 },
      { at:0,   type:'particle_stream',origin:'actor',  color:'#556633', count:6, spread:32, direction:'up', duration:320 },
      ...
      { at:420, type:'creature_tint',  target:'target', color:'#334422', blend:'multiply', duration:500 },
      { at:420, type:'preset',         id:'earth_particle_heavy' },
      { at:420, type:'preset',         id:'earth_hit_flash_heavy' },
      { at:420, type:'shockwave',      origin:'target', size:82, color:'#664422', opacity:0.60, thickness:3, duration:380 },
  ...
  moss_strike_3: {
    timeline: [
      ...
      { at:0,   type:'creature_tint',  target:'actor',  color:'#556633', blend:'screen',   duration:480 },
      { at:0,   type:'preset',         id:'earth_cast_aura', count:12, spread:40 },
      { at:0,   type:'particle_stream',origin:'actor',  color:'#556633', count:7, spread:36, direction:'up', duration:380 },
      ...
      { at:500, type:'creature_tint',  target:'target', color:'#334422', blend:'multiply', duration:520 },
      { at:500, type:'preset',         id:'earth_particle_heavy' },
      { at:500, type:'preset',         id:'earth_hit_flash_heavy' },
      { at:500, type:'shockwave',      origin:'target', size:100, color:'#664422', opacity:0.68, thickness:4, duration:400 },
  ...
  spore_drift: {
    timeline: [
      ...
      { at:420, type:'creature_tint',  target:'target', color:'#334422', blend:'multiply', duration:600 },
      { at:420, type:'particle_burst', origin:'target', color:'#334422', count:10, spread:50, direction:'all', duration:600 },
      { at:420, type:'status_ring',    target:'target', color:'#556633', duration:720 },
  ...
  root_grab: {
    timeline: [
      ...
      { at:0,   type:'creature_tint',  target:'actor',  color:'#556633', blend:'screen',   duration:440 },
      ...
      { at:380, type:'creature_tint',  target:'target', color:'#334422', blend:'multiply', duration:560 },
      { at:380, type:'status_ring',    target:'target', color:'#664422', duration:680 },
  ...
  earth_slab: {
    timeline: [
      ...
      { at:520, type:'creature_tint',  target:'target', color:'#334422', blend:'multiply', duration:520 },
      { at:520, type:'preset',         id:'earth_particle_heavy' },
      { at:520, type:'preset',         id:'earth_hit_flash_heavy' },
      { at:520, type:'shockwave',      origin:'target', size:88, color:'#664422', opacity:0.62, thickness:3, duration:380 },
  ...
  overgrowth: {
    timeline: [
      ...
      { at:0,   type:'creature_tint',  target:'actor',  color:'#556633', blend:'screen',   duration:580 },
      ...
      { at:440, type:'impact' },
      { at:440, type:'status_ring',    target:'actor',  color:'#556633', duration:750 },
  ...
  mudslide: {
    timeline: [
      ...
      { at:0,   type:'creature_tint',  target:'actor',  color:'#556633', blend:'screen',   duration:520 },
      { at:0,   type:'preset',         id:'earth_cast_aura', count:8 },
      { at:340, type:'sound',          id:'hit-heavy' },
      { at:400, type:'impact' },
      { at:400, type:'shockwave',      origin:'actor',  size:95, color:'#664422', opacity:0.62, thickness:3, duration:400 },
  ...
  // ── vine_snare ────────────────────────────────────────────────────────────
  // Stun utility. Vines erupt and bind the target completely.
  vine_snare: {
    timeline: [
      { at:0,   type:'sound',          id:'charge-light' },
      ...
      { at:400, type:'creature_tint',  target:'target', color:'#334422', blend:'multiply', duration:600 },
      { at:400, type:'particle_burst', origin:'target', color:'#334422', count:14, spread:55, direction:'all', duration:540 },
      { at:400, type:'status_ring',    target:'target', color:'#334422', duration:720 },
  ...
  spore_burst: {
    timeline: [
      ...
      { at:0,   type:'creature_tint',  target:'actor',  color:'#556633', blend:'screen',   duration:540 },
      { at:0,   type:'preset',         id:'earth_cast_aura', color:'#556633', count:10 },
      { at:300, type:'impact' },
      { at:300, type:'shockwave',      origin:'actor',  size:90, color:'#556633', opacity:0.55, thickness:3, duration:400 },
  ...
  moss_wall: {
    timeline: [
      ...
      { at:0,   type:'creature_tint',  target:'actor',  color:'#556633', blend:'screen',   duration:640 },
      ...
      { at:460, type:'impact' },
      { at:460, type:'status_ring',    target:'actor',  color:'#556633', duration:800 },
      { at:540, type:'status_ring',    target:'actor',  color:'#664422', duration:700 },
  ...
  stone_press: {
    timeline: [
      ...
      { at:0,   type:'creature_tint',  target:'actor',  color:'#556633', blend:'screen',   duration:620 },
      { at:0,   type:'preset',         id:'earth_cast_aura', count:10, spread:35 },
      { at:0,   type:'particle_stream',origin:'actor',  color:'#664422', count:7, spread:32, direction:'up', duration:480 },
      { at:120, type:'preset',         id:'earth_projectile_heavy', size:28, duration:440 },
      { at:700, type:'impact' },
      { at:700, type:'hit_stop',       duration:55 },
      { at:700, type:'sound',          id:'hit-heavy' },
      { at:700, type:'creature_anim',  target:'target', class:'anim-hit-earth-heavy' },
      { at:700, type:'creature_tint',  target:'target', color:'#334422', blend:'multiply', duration:560 },
      { at:700, type:'preset',         id:'earth_particle_heavy' },
      { at:700, type:'preset',         id:'earth_hit_flash_heavy' },
      { at:700, type:'shockwave',      origin:'target', size:112, color:'#664422', opacity:0.72, thickness:4, duration:420 },
  ...
  stone_press_2: {
    timeline: [
      ...
      { at:0,   type:'creature_tint',  target:'actor',  color:'#556633', blend:'screen',   duration:720 },
      { at:0,   type:'preset',         id:'earth_cast_aura', count:14, spread:45 },
      { at:0,   type:'particle_stream',origin:'actor',  color:'#664422', count:9, spread:38, direction:'up', duration:560 },
      { at:140, type:'preset',         id:'earth_projectile_heavy', size:34, duration:500 },
      { at:800, type:'impact' },
      { at:800, type:'hit_stop',       duration:65 },
      { at:800, type:'sound',          id:'hit-heavy' },
      { at:800, type:'creature_anim',  target:'target', class:'anim-hit-earth-heavy' },
      { at:800, type:'creature_tint',  target:'target', color:'#334422', blend:'multiply', duration:600 },
      { at:800, type:'preset',         id:'earth_particle_heavy' },
      { at:800, type:'preset',         id:'earth_hit_flash_heavy' },
      { at:800, type:'shockwave',      origin:'target', size:132, color:'#664422', opacity:0.78, thickness:5, duration:440 },
  ...
  mudslide_2: {
    timeline: [
      ...
      { at:0,   type:'creature_tint',  target:'actor',  color:'#556633', blend:'screen',   duration:660 },
      { at:0,   type:'preset',         id:'earth_cast_aura', count:14, spread:50 },
      { at:440, type:'sound',          id:'hit-heavy' },
      { at:500, type:'impact' },
      { at:500, type:'hit_stop',       duration:55 },
      { at:500, type:'shockwave',      origin:'actor',  size:120, color:'#664422', opacity:0.72, thickness:4, duration:420 },
  ...
  petrify: {
    timeline: [
      ...
      { at:0,   type:'creature_tint',  target:'actor',  color:'#556633', blend:'screen',   duration:560 },
      { at:0,   type:'preset',         id:'earth_cast_aura', count:10, spread:40 },
      { at:0,   type:'particle_stream',origin:'actor',  color:'#886644', count:6, spread:30, direction:'up', duration:420 },
      ...
      { at:700, type:'creature_tint',  target:'target', color:'#664433', blend:'multiply', duration:640 },
      { at:700, type:'particle_burst', origin:'target', color:'#886644', count:14, spread:55, direction:'all', duration:560 },
      { at:700, type:'status_ring',    target:'target', color:'#886644', duration:760 },
      { at:700, type:'preset',         id:'earth_hit_flash_heavy' },
  ...
  ancient_crush: {
    timeline: [
      ...
      { at:0,   type:'creature_tint',  target:'actor',  color:'#556633', blend:'screen',   duration:800 },
      { at:0,   type:'preset',         id:'earth_cast_aura', count:16, spread:55 },
      { at:0,   type:'particle_stream',origin:'actor',  color:'#664422', count:12, spread:48, direction:'up', duration:620 },
      { at:620, type:'sound',          id:'hit-heavy' },
      { at:620, type:'creature_anim',  target:'actor',  class:'anim-cast-ancient-crush-lunge', lunge:true },
      { at:840, type:'impact' },
      { at:840, type:'hit_stop',       duration:90 },
      { at:840, type:'sound',          id:'hit-heavy' },
      { at:840, type:'creature_anim',  target:'target', class:'anim-hit-earth-heavy' },
      { at:840, type:'creature_tint',  target:'target', color:'#334422', blend:'multiply', duration:740 },
      { at:840, type:'preset',         id:'earth_particle_heavy' },
      { at:840, type:'preset',         id:'earth_hit_flash_heavy' },
      { at:840, type:'shockwave',      origin:'target', size:150, color:'#664422', opacity:0.85, thickness:5, duration:480 },
      { at:880, type:'shockwave',      origin:'target', size:80,  color:'#886644', opacity:0.58, thickness:3, duration:400 },
      ...
      { at:1020,type:'particle_burst', origin:'target', color:'#664422', count:18, spread:70, direction:'all', duration:520 },
