...
This document defines Creature Battle’s rental creature baseline and rental draft structure.
...
Creature Battle should support rental creatures from the beginning.
...
Rental mode prevents Creature Battle from depending entirely on RPG progress.
