...
This document defines how Creature Battler wraps the shared combat core.

Creature Battler modes may restrict creature source, items, variants, Trainer Affinity, passives, moves, level caps, or other legality rules. They must not reinterpret the shared combat rules.

## Mode Structure

Creature Battler should launch with a small set of battle modes that all use the same shared combat core.
