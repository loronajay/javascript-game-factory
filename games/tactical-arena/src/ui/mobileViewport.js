// Mobile playability shell (ported from Mini-Tactics). Pure viewport logic with
// no game knowledge: it reads the live viewport, decides the posture (portrait
// rotate-gate vs. playable landscape), exposes that through data-attributes the
// stylesheet keys off, and requests fullscreen on playable phone landscape.
// Kept dependency-free + injectable so the headless test can drive it.
