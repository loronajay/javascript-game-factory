export const NEMESIS = Object.freeze({
  ...
  arts: Object.freeze([
    Object.freeze({
      ...
      description: "Scatter dark balls in all 8 straight lines. Each ray hits the first unit contacted: enemies take 5 magic damage and allies heal 1 HP. Refund the MP cost if 4 targets are hit.",
      implemented: true,
