  ...
  return `
    <div class="mobile-landscape-gate-card">
      ...
      <div class="mobile-landscape-gate-copy" data-mobile-gate-copy>
        Bird Duty needs a wide sky view for clean aiming. Rotate your device, then enter fullscreen so the drop button and runway stay easy to reach.
      </div>
...
function initMobileLandscapeGate(options = {}) {
  ...
  function update() {
    ...
    if (status.needsRotation) {
      ...
      copy.textContent = "Bird Duty needs a wide sky view for clean aiming. Rotate your device, then enter fullscreen for the best drop-shot setup.";
      ...
      copy.textContent = "Landscape is set. Fullscreen hides browser chrome so the runway, target lanes, and touch controls stay in reach.";
