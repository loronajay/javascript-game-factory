// Tickets for a finished run or race: an id is minted when play starts and
...
//
// The platform client is imported lazily, as online-identity.js does, so the
// cabinet still boots when it is served on its own. What gets filed at all is decided
// by the pure builder in ticket-result.js.
