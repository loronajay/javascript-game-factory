 ...
 */
export function createPond(THREE, width, depth) {
    const group = new THREE.Group();
...
export function createLilyPond(THREE, width, depth) {
    ...
    const spots = [[-0.28, -0.18, 0.22], [0.16, -0.3, 0.18], [0.3, 0.12, 0.24], [-0.1, 0.28, 0.2], [-0.32, 0.22, 0.16], [0.02, -0.02, 0.15]];
