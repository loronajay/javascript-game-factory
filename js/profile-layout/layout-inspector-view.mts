...
function renderChildLayoutControls(panel: any, childEditPanelId: string | null, selectedChildId: string | null): string {
...
function renderStyleControls(item: any, def: any = null): string {
...
function renderColorControl(label: string, key: string, value: unknown): string {
  return `
