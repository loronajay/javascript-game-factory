...
export const PROFILE_COMPOSITION_ELEMENT_REGISTRY: Record<string, any> = {
  heroSurface: {
    label: "Hero Surface",
    category: "hero",
    type: "surface",
...
export function isCustomTitleElementId(id: unknown): boolean {
  return typeof id === "string" && id.startsWith(CUSTOM_TITLE_PREFIX);
}

export function getCompositionElementDef(id: string) {
