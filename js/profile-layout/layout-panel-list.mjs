...
const ELEMENT_GROUP_FALLBACK_LABELS = {
...
function groupLabelFor(key, panelRegistry) {
    if (key === PANELS_GROUP_KEY)
        return "Panels";
 ...
 */
function resolveExpanded(key, { enabledCount, hasSelection }, groupOverrides) {
...
export function buildPanelListGroups({ panels = [], elements = [], selectedPanelId = null, panelRegistry, getElementDef, isCustomTitleElementId, query = "", groupOverrides = {}, }) {
...
export function renderPanelListHtml(options) {
