...
import { fetchLayout, saveLayout } from "./layout-storage.mjs?v=20260524-gallery-photo-fix-2";
import { normalizeLayout } from "./normalize-layout.mjs?v=20260524-gallery-photo-fix-2";
import { getDefaultLayout } from "./default-layout.mjs?v=20260524-gallery-photo-fix-2";
...
} from "./composition-layout.mjs?v=20260524-gallery-photo-fix-2";
import {
  buildZoomFrame,
  clampZoom,
  computeFitZoom,
...
import { applyCompositionElementScaling, renderLayoutGrid } from "./layout-renderer.mjs?v=20260524-gallery-photo-fix-2";
import { initLayoutEditor, getGridMetrics } from "./layout-editor.mjs?v=20260524-gallery-photo-fix-2";
