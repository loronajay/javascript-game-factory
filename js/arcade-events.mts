...
export function buildEventsPageViewModel(events: any = buildPublicEventFeed()) {
...
export function renderEventsPage(doc: Document = globalThis.document, events: any = buildPublicEventFeed()) {
...
export async function loadEventsForPage(client: any = createContentApiClient()) {
