export async function openGalleryItemInViewer({ galleryItem, fullViewer, viewerActions = null, hasApi = false, locationHref = globalThis.location?.href, }) {
...
export function openThoughtImageInViewer({ thoughtImg, thoughtViewer, galleryPageHref = "../gallery/index.html", now = Date.now, }) {
    if (!thoughtImg)
        return false;
...
export function createPageGalleryViewerClickHandler({ fullViewer, thoughtViewer, viewerActions = null, galleryPageHref = "../gallery/index.html", hasApi = false, now = Date.now, locationHref = globalThis.location?.href, }) {
