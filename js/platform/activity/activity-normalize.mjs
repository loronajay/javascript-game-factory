import { ACTIVITY_TYPES, ACTIVITY_VISIBILITIES, } from "./activity-schema.mjs";
...
function sanitizeMetadataValue(value, depth = 0) {
    if (depth > 3)
        return null;
    if (typeof value === "string")
        return sanitizeSingleLine(value, 280);
...
export function normalizeIdentity(rawIdentity = {}) {
...
export function normalizeActivityItem(rawItem = {}, index = 0) {
    const item = rawItem;
...
export function buildDerivedSessionId(rawActivity) {
    ...
    if (!gameSlug || !createdAt || !leftPlayerId || !rightPlayerId)
        return "";
