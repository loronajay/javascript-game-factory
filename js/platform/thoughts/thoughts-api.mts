...
export interface ThoughtApiOptions extends PlatformApiClientOptions {
  storage?: MaybeStorage;
  apiClient?: PlatformApiClient | null;
  caption?: unknown;
}

function cacheThoughtPosts(storage: MaybeStorage, additions: unknown[] = [], options: { removeIds?: unknown } = {}): void {
...
export async function syncThoughtCommentsFromApi(
  ...
  storage: MaybeStorage = getDefaultPlatformStorage(),
  apiClient: PlatformApiClient = createPlatformApiClient(),
): Promise<NormalizedThoughtComment[]> {
