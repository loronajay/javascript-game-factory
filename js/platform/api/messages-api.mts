...
export function createMessagesApiClient(options: PlatformApiClientOptions = {}) {
  ...
  return {
    ...
    async findConversationWith(playerId: string) {
    ...
    async sendMessage(toPlayerId: string, text: string) {
