...
type LocationLike = Readonly<{ protocol?: string; hostname?: string }> | null | undefined;

function isLocalHostname(hostname: string): boolean {
  return hostname === "localhost" || hostname === "127.0.0.1" || hostname === "::1";
}

export function resolveFactoryNetworkUrl(locationLike: LocationLike = globalThis.location): string {
