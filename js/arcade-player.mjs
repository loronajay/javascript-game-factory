...
import {
  ...
  sanitizePlayerId,
} from "./player-page/loader.mjs";
import { buildPlayerPageViewModel } from "./player-page/view-model.mjs";
...
export { loadPlayerPageData, loadRequestedPlayerProfile } from "./player-page/loader.mjs";
export { buildPlayerPageViewModel } from "./player-page/view-model.mjs";
