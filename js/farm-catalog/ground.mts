...
export type GroundDefinition = Readonly<{
  id: string;
  title: string;
...
function ground(id: string, title: string, swatch: readonly [string, string], style: SurfaceStyle, unlock: GroundDefinition["unlock"] = PURCHASE): GroundDefinition {
...
export const GROUND_CATALOG: readonly GroundDefinition[] = Object.freeze([
