...
type AnimalSpec = Readonly<{ title: string; file: string; habitat: AnimalHabitat; height: number; radius: number; walkSpeed: number; turnRate?: number; hoverHeight?: number }>;
