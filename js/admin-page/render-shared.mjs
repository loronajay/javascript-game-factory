...
export function field(label, inputMarkup, hint = "") {
    return `
...
export function button(action, label, { tone = "", value = "", type = "button" } = {}) {
...
export function panel(title, bodyMarkup, actionsMarkup = "") {
    return `
...
export function statusTone(status) {
    ...
    if (value === "published" || value === "live" || value === "resolved")
        return "good";
    if (value === "draft" || value === "scheduled" || value === "open")
        return "warn";
    if (value === "archived" || value === "cancelled" || value === "dismissed")
        return "muted";
    return "";
}
