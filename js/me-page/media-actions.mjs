export async function uploadPendingThoughtPhoto({ currentProfile, mediaComposer, apiClient, loadGallery, subject = "", text = "", } = {}) {
...
export async function submitGalleryUpload({ currentProfile, mediaComposer, apiClient, loadGallery, onUploadStart, } = {}) {
