...
import { loadProfileRelationshipsRecord, normalizeProfileRelationshipsRecord, } from "../platform/relationships/relationships.mjs";
import { enrichProfileFriendPreviewsFromApi } from "../platform/profile/friend-preview-enrichment.mjs";
import { loadThoughtFeed, syncThoughtFeedFromApi, } from "../platform/thoughts/thoughts.mjs";
export function createMePageDataController(options = {}) {
    ...
    return {
        ...
        async loadRenderState({ shouldHydrate = false } = {}) {
            ...
            const normalizedRelationships = normalizeProfileRelationshipsRecordImpl(hydrated.relationshipsRecord?.playerId
                ? hydrated.relationshipsRecord
                : { playerId: currentProfile.playerId });
            const enrichedProfile = await enrichProfileFriendPreviewsFromApiImpl(hydrated.profile, normalizedRelationships, apiClient);
