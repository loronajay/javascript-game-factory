...
interface AddFriendByCodeOptions {
  storage?: StorageLike | null;
  apiClient?: PlatformApiClient;
}

interface AddFriendByCodeResult {
  ok: boolean;
  message: string;
  targetProfile?: any;
...
export async function addFriendByCode(friendCode: unknown, options: AddFriendByCodeOptions = {}): Promise<AddFriendByCodeResult> {
