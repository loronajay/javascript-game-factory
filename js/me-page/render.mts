...
import type { MePageViewModel } from "./view-model.mjs";

export function renderMePage(doc: Document = globalThis.document, profile: any = loadFactoryProfile(), options: any = {}): MePageViewModel | null {
