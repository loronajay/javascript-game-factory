...
export function createProfileSocialActions({ loadCurrentProfile, loadThoughtComments, syncThoughtComments, commentOnThought, shareThought, reactToThought, deleteThought, rerenderView, rerenderPanels, afterDelete, } = {}) {
    ...
    return {
        ...
        handleInput(event) {
            ...
            const captionInput = target?.closest("[data-share-caption-input]");
            if (captionInput) {
                sharePanelState = {
                    ...sharePanelState,
            ...
            const commentInput = target?.closest("[data-comment-input]");
            if (commentInput) {
                commentPanelState = {
                    ...commentPanelState,
