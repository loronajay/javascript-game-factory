...
function buildInitials(name: any): string {
...
function renderResults(players: any[]): void {
  ...
  list.innerHTML = players.map((p: any) => {
...
async function runSearch(query: any): Promise<void> {
