...
import { loadProfileRelationshipsRecord, saveProfileRelationshipsRecord, } from "../platform/relationships/relationships.mjs";
import { loadProfileMetricsRecord, saveProfileMetricsRecord, } from "../platform/metrics/metrics.mjs";
...
export async function hydrateArcadeProfileFromApi(storage = getDefaultPlatformStorage(), apiClient = createPlatformApiClient(), options = {}) {
