import { FRIEND_RAIL_SLOT_COUNT, PROFILE_LINK_ROW_COUNT, } from "./constants.mjs";
...
export function collectFriendSlotPlayerIds(doc) {
    return Array.from({ length: FRIEND_RAIL_SLOT_COUNT }, (_, index) => (inputValue(doc, `playerProfileFriendSlot${index + 1}`)));
}
