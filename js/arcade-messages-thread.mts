...
function formatTime(isoString: any): string {
  if (!isoString) return "";
  try {
...
function renderBubble(msg: any, viewerPlayerId: any): HTMLDivElement {
...
async function run(): Promise<void> {
  ...
  const inputEl = document.getElementById("msgInput") as HTMLInputElement | null;
  ...
  function appendMessages(messages: any): void {
    let appended = false;
