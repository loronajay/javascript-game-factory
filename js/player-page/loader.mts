...
export interface PlayerPageLoadOptions extends PlatformApiClientOptions {
...
function buildThoughtBackedProfile(thoughtFeed: unknown[] = [], requestedPlayerId = ""): Record<string, any> | null {
...
export function loadRequestedPlayerProfile(storage: StorageLike | null = getDefaultPlatformStorage(), requestedPlayerId = "", options: { thoughtFeed?: unknown[] } = {}): any {
...
export async function loadPlayerPageData(options: PlayerPageLoadOptions = {}): Promise<PlayerPageData> {
