...
import type { FriendAction, GestureAction, MessageAction } from "./actions-view-model.mjs";
...
export interface PlayerThoughtComposer {
  enabled: boolean;
...
export interface PlayerPageViewModel {
  ...
  heroStats: any[];
  identityLinkItems: any[];
  favoriteGameItems: any[];
  rankingItems: any[];
  friendItems: any[];
  thoughtItems: ThoughtCardItem[];
  thoughtComposer: PlayerThoughtComposer;
  ...
  presenceToneClass?: string;
  backgroundImageUrl?: string;
  backgroundStyle?: string;
}

export interface BuildPlayerPageViewModelOptions {
...
function resolveProfilePresence(presence: unknown, isOwnerView: boolean): string {
...
export function buildPlayerPageViewModel(profile: any, options: BuildPlayerPageViewModelOptions = {}): PlayerPageViewModel {
