...
function glow(THREE: ThreeNamespace, color: string, intensity = 1.2): any {
...
function addBall(THREE: ThreeNamespace, parent: any, x: number, y: number, z: number, color: string): void {
