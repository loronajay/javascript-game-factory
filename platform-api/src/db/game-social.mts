...
} from "./game-social/game-social-shared.mjs";
...
} from "./game-social/game-friend-requests.mjs";

export {
  areGameFriends,
  listGameFriends,
  removeGameFriend,
} from "./game-social/game-friendships.mjs";

export {
  blockGamePlayer,
  listGameBlocks,
  unblockGamePlayer,
} from "./game-social/game-friend-blocks.mjs";
...
export {
  ...
  searchGamePlayers,
} from "./game-social/game-player-search.mjs";
