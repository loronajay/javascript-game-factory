...
function mapRowToMetricsRecord(row: any = {}, fallbackPlayerId = ""): any {
...
function buildMetricsParams(playerId: any, metrics: any): any[] {
  return [
    playerId,
...
export async function loadPlayerMetrics(db: any, playerId: any): Promise<any> {
...
export async function savePlayerMetrics(db: any, playerId: any, patch: any = {}): Promise<any> {
  const normalizedPlayerId = sanitizePlayerId(playerId);
