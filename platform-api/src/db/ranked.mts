...
function appendFlag(existing: any, flag: any): any {
...
export async function reportRankedResult(pool: any, { matchId, gameSlug, reporterPlayerId, outcome, minMatchSeconds, now }: any): Promise<any> {
