...
async function loadRelationshipLedgerEntry(db: any, ledgerKey: any): Promise<any> {
...
async function saveRelationshipLedgerEntry(db: any, entry: any = {}): Promise<any> {
...
export async function loadPlayerRelationships(db: any, playerId: any): Promise<any> {
...
export async function savePlayerRelationships(db: any, playerId: any, patch: any = {}): Promise<any> {
  const normalizedPlayerId = sanitizePlayerId(playerId);
...
export async function createFriendshipBetweenPlayers(db: any, leftPlayerId: any, rightPlayerId: any, options: any = {}): Promise<any> {
...
export async function recordSharedSessionBetweenPlayers(db: any, leftPlayerId: any, rightPlayerId: any, options: any = {}): Promise<any> {
  const normalizedLeftPlayerId = sanitizePlayerId(leftPlayerId);
  const normalizedRightPlayerId = sanitizePlayerId(rightPlayerId);
  const pairKey = buildRelationshipPairKey(normalizedLeftPlayerId, normalizedRightPlayerId);
...
export async function recordSharedEventBetweenPlayers(db: any, leftPlayerId: any, rightPlayerId: any, options: any = {}): Promise<any> {
  const normalizedLeftPlayerId = sanitizePlayerId(leftPlayerId);
  const normalizedRightPlayerId = sanitizePlayerId(rightPlayerId);
  const pairKey = buildRelationshipPairKey(normalizedLeftPlayerId, normalizedRightPlayerId);
...
export async function removeFriendBetweenPlayers(db: any, leftPlayerId: any, rightPlayerId: any): Promise<any> {
  const normalizedLeftPlayerId = sanitizePlayerId(leftPlayerId);
  const normalizedRightPlayerId = sanitizePlayerId(rightPlayerId);
  const pairKey = buildRelationshipPairKey(normalizedLeftPlayerId, normalizedRightPlayerId);
...
export async function recordDirectInteractionBetweenPlayers(db: any, leftPlayerId: any, rightPlayerId: any, options: any = {}): Promise<any> {
  const normalizedLeftPlayerId = sanitizePlayerId(leftPlayerId);
  const normalizedRightPlayerId = sanitizePlayerId(rightPlayerId);
  const pairKey = buildRelationshipPairKey(normalizedLeftPlayerId, normalizedRightPlayerId);
