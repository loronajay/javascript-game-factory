...
export function toTimestampOrNull(value: unknown): string | null {
...
export function singleLine(value: unknown, maxLength: number): string {
  if (typeof value !== "string") return "";
  return value.replace(/\s+/g, " ").trim().slice(0, maxLength);
}

export function textBlock(value: unknown, maxLength: number): string {
  if (typeof value !== "string") return "";
...
export function stringList(value: unknown, maxItems = 24, maxLength = 80): string[] {
  let source = value;
...
export function httpUrl(value: unknown, maxLength = 500): string {
