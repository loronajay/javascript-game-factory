...
function mapRowToConversation(row: any = {}): any {
...
function mapRowToMessage(row: any = {}): any {
  if (!row?.id) return null;
  return {
    id: String(row.id || ""),
...
function normalizePair(p1: any, p2: any): [any, any] {
  return p1 <= p2 ? [p1, p2] : [p2, p1];
}

export async function findOrCreateConversation(db: any, playerOneId: any, playerTwoId: any): Promise<any> {
...
export async function findConversationBetween(db: any, playerOneId: any, playerTwoId: any): Promise<any> {
...
export async function listConversations(db: any, playerId: any): Promise<any> {
...
export async function getConversation(db: any, conversationId: any): Promise<any> {
...
export async function listMessages(db: any, conversationId: any): Promise<any> {
...
export async function createMessage(db: any, { conversationId, fromPlayerId, text }: any = {}): Promise<any> {
...
export async function markConversationRead(db: any, conversationId: any, playerId: any): Promise<void> {
