...
export function sanitizeThoughtId(value: unknown): string {
...
export function sanitizeViewerPlayerId(value: unknown): string {
  return typeof value === "string" ? value.trim().slice(0, 80) : "";
}

export function sanitizeViewerAuthorDisplayName(value: unknown): string {
...
export function sanitizeReactionId(value: unknown): string {
...
export function mapRowToThought(row: any = {}, options: any = {}): any {
...
export function mapRowToComment(row: any = {}): any {
...
export function buildThoughtParams(thought: any): any[] {
  return [
    thought.id,
...
export function mapReactionTotalsByThoughtId(reactionRows: any[] = [], fallbackRows: any[] = []): Map<string, any> {
  const totalsByThoughtId = new Map<string, any>();
...
export function mapViewerReactionByThoughtId(rows: any[] = []): Map<string, string> {
  const viewerReactionByThoughtId = new Map<string, string>();
...
export function mapViewerShareByOriginalThoughtId(rows: any[] = []): Map<string, string> {
  const viewerShareByOriginalThoughtId = new Map<string, string>();
...
function createSuffix(options: any = {}): string {
  const now = typeof options.now === "function" ? options.now() : Date.now();
  const random = typeof options.random === "function" ? options.random() : Math.random();
  return `${Number(now).toString(36)}-${String(random.toString(36).slice(2, 8))}`;
}

export function createSharedThoughtId(originalThoughtId: any, viewerPlayerId: any, options: any = {}): string {
...
export function createCommentId(thoughtId: any, viewerPlayerId: any, options: any = {}): string {
  return sanitizeThoughtId(
    `comment-${sanitizeThoughtId(viewerPlayerId).slice(0, 24)}-${sanitizeThoughtId(thoughtId).slice(0, 24)}-${createSuffix(options)}`,
  );
}

export function deriveNextViewerReaction(existingReactionId: any, requestedReactionId: any): string {
...
export function buildReactedThought(thoughtRow: any, reactionTotals: any, viewerReaction: any): any {
...
export function createSharedThought(originalThoughtRow: any = {}, viewerPlayerId: any = "", viewerAuthorDisplayName: any = "", options: any = {}): any {
...
export function buildShareResult(originalThoughtRow: any = {}, shareCount: any = 0, options: any = {}): any {
...
export function buildCommentRecord(thoughtId: any, viewerPlayerId: any, viewerAuthorDisplayName: any, text: any, options: any = {}): any {
...
export function buildCommentResult(thoughtRow: any = {}, commentCount: any = 0, comment: any = {}): any {
  return {
