...
function mapRowToChallenge(row: any = {}): any {
...
export async function createChallenge(db: any, {
  fromPlayerId,
  toPlayerId,
  fromDisplayName = "",
  gameSlug,
...
export async function getChallenge(db: any, id: any): Promise<any> {
...
export async function acceptChallenge(db: any, id: any): Promise<any> {
  if (!db || !id) return null;
...
export async function declineChallenge(db: any, id: any): Promise<any> {
  if (!db || !id) return null;
