...
function mapRowToActivityItem(row: any = {}): any {
...
function isLegacySchemaMismatch(error: any): boolean {
...
export async function listActivityItems(db: any, options: any = {}): Promise<any> {
...
export async function saveActivityItem(db: any, item: any = {}): Promise<any> {
