...
const COMPLETION_CAP = { training: 25, online: 30 };
const WIN_BONUS = { training: 10, online: 15 };
const MS_PER_TICKET_CEILING = 7_000;
export function normalizeCreatureBattlerResult(raw) {
    ...
    if (rounds === null || durationMs === null)
...
export function calculateCreatureBattlerTicketReward({ result }) {
