...
function settingKey(appId, platform) {
...
export function resolveAppReleasePolicy({ appId = DEFAULT_APP_ID, platform = ANDROID_PLATFORM, settings = {}, env = {}, } = {}) {
    const registered = PACKAGED_APPS[appId];
    if (!registered || registered.platform !== platform)
        return null;
