...
export async function handleThoughtRoute(context) {
    const { req, res, method, pathname, requestUrl, requestOrigin, timestamp, services, } = context;
    const { listThoughts, listThoughtComments, saveThought, shareThought, commentOnThought, reactToThought, deleteThought, createNotification, } = services;
