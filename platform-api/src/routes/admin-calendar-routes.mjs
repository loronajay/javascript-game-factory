...
export async function handleAdminCalendarRoute(context) {
    const { req, res, method, pathname, requestOrigin, timestamp, services, adminPlayerId } = context;
    const { listCalendarOrders, getCalendarOrder, updateCalendarFulfillment, getCalendarPreorderMetrics, writeAuditLog, } = services;
