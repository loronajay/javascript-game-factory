...
export async function handleRankedRoute(context) {
    ...
    if (!queueMatch && !startMatch && !reportMatch && !heartbeatMatch && !standingMatch && !lobbyMatch && !profileMatch && !cardMatch && !unitsMatch && !matchesMatch && !matchDetailMatch && !leaderboardMatch)
        return false;
