...
export function writeJson(res: any, statusCode: number, payload: any, requestOrigin?: any): void {
...
export async function readJsonBody(req: any): Promise<{ ok: boolean; value?: any; error?: string }> {
  const chunks: Buffer[] = [];
...
export function readMultipartFile(req: any): Promise<any> {
  return new Promise<any>((resolve) => {
    ...
    bb.on("file", (_fieldname: any, fileStream: any, info: any) => {
