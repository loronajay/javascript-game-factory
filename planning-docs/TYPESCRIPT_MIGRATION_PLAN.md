...
### ▶ RESUME HERE — Phase 7 (root `js/*` page entry points + utilities)

Baseline at last `profile-layout` commit: working tree clean, `npm run typecheck:browser` = 0, `npm run typecheck:api` = 0, all 91 browser test files green. **All of Phase 6 is done.**
