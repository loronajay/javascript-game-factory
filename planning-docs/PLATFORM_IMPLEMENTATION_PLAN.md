...
- Next scoped customization work is a manual browser QA pass for the completed live-preview foundation, followed by deeper hero-panel appearance controls and sub-grid planning. The rule: editor previews must reuse live renderers/CSS variables or they are not trustworthy. See `profile-editor-plans/04_PANEL_APPEARANCE_EDITOR_SCOPE.md`.
